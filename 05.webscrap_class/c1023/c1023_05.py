...
#   # 파일 저장하기
#   with open(f"c1023/yeogi{i+1}.html",'w',encoding='utf8') as f:
#     f.write(soup.prettify())
#   # print(data)


# 평가 수 9.0이상, 평가수 500이상, 금액:120000원 이하만 출력
# 파일 5개를 모두 검색해서 출력하세요.
for i in  range(5):
  with open(f"c1023/yeogi{i+1}.html", 'r', encoding='utf8') as f:
  ...
  for idx,sell in enumerate(sells):
    ...
    if num < 500:
      ...
      continue
    print(f"{idx+1}")
    print("상품명 : ",sell.select_one("div.css-8fn780").text.strip())
...
# with open("c1023/yeogi.html",'r',encoding='utf8') as f:
#  soup = BeautifulSoup(f,'lxml')
...
# with open("c1023/yeogi.html",'w',encoding='utf8') as f:
#  f.write(soup.prettify())
# data = soup.select_one('#__next > div > main > section > div.css-1qumol3')
# print(res)
